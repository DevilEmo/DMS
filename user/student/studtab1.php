...
echo round($date_diff, 0)." days left";
 ...
 ?></p>
        ...
        <div class="card-action">
          <a class="waves-effect waves-light btn modal-trigger" href="#modal1<?php echo $row['id'];?>">Information</a>
        </div>
      </div>
    </div>
  </div>
...
?>    
    <div class="modal-content">
      ...
      <p><?php echo $row['teacher'];?>-schedule</p>
    </div>
    <?php } ?>          
    <div class="modal-footer">
    <a href="#!" class="modal-close waves-effect waves-green btn red">Close</a>
    <a href="#!" class="modal-close waves-effect waves-green btn">Process</a>
    </div>
  </div>
<?php } ?> 
