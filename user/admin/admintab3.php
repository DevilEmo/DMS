  ...
  overflow:auto;">
        ...
        <li class="collection-item row" style="padding:0px; margin:5px; ">
            ...
            <div class="col m2">
              ...
              <a onclick="return confirm('Are you sure you want to delete this entry?')" href="admin/delete_subject.php?id=<?= $subj->id ?>" 
    ...
    <form method="post" action="admin/query.php" enctype="multipart/form-data" id="import_form">
    ...
    <form method="post" action="admin/query.php?id=<?= $subj->id ?>" enctype="multipart/form-data" id="import_form">
        <div class="modal-content">
